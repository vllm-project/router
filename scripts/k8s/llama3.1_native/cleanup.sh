...
# Cleanup Llama 3.1 8B native deployment
# Usage: ./cleanup.sh [namespace] [gateway-provider]
#
# Examples:
#   ./cleanup.sh                                # Cleanup from llm-d-llama31-native with default
#   ./cleanup.sh llm-d-llama31-native istio     # Cleanup from llm-d-llama31-native with istio
...
echo "===================================="
echo "Cleaning up Llama 3.1 8B Native"
echo "===================================="
