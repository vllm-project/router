...
def test_router_defaults_and_start(monkeypatch):
    ...
    """
    from vllm_router import router as router_mod
    ...
    from vllm_router.router_args import RouterArgs as _RouterArgs
...
def test_find_available_ports_and_wait_health(monkeypatch):
    ...
    ls = importlib.import_module("vllm_router.launch_server")
